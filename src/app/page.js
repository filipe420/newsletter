...
export default function Home() {
  ...
  return (
    ...
    <div className="h-[24rem] md:h-[28rem] w-full max-w-5xl bg-black rounded-lg flex flex-col md:flex-row items-center p-4 overflow-hidden">
      ...
      <div className="w-full md:w-2/3 px-4 md:px-16 min-h-[12rem] md:min-h-full flex flex-col text-white justify-center items-center gap-5 text-center overflow-hidden">
